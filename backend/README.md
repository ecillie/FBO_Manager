...
The accepted design is recorded in [ADR 0002: Backend application architecture and dependency boundaries](../docs/architecture/decisions/0002-backend-application-architecture.md). The [API contracts and operational data flows](../docs/architecture/api-contracts-and-data-flows.md), [ADR 0003](../docs/architecture/decisions/0003-api-contracts-and-operational-data-flows.md), [MVP architecture](../docs/architecture.md), [workflow definitions](../docs/architecture/mvp-scope-and-workflows.md), [quality attributes](../docs/architecture/quality-attributes.md), [database design](../docs/database-design.md), and [initial PostgreSQL schema](../db/init/001_schema.sql) are the other controlling sources.
