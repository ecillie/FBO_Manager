...
The accepted design is recorded in [ADR 0002: Backend application architecture and dependency boundaries](../docs/architecture/decisions/0002-backend-application-architecture.md). The [MVP architecture](../docs/architecture.md), [workflow definitions](../docs/architecture/mvp-scope-and-workflows.md), [quality attributes](../docs/architecture/quality-attributes.md), [database design](../docs/database-design.md), and [initial PostgreSQL schema](../db/init/001_schema.sql) are the other controlling sources.
